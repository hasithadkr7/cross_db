...
-export([all/0]).
%% Test Cases
-export([t_cast_string/1, t_cast_float/1, t_cast_integer/1, t_cast_boolean/1,
         t_cast_date/1, t_cast_datetime/1, t_cast_binary/1, t_cast_custom/1, t_cast_field_name/1]).
...
t_cast_datetime(_Config) ->
    {ok, undefined} = xdb_schema_type:cast(datetime, undefined),
    {ok, {{2012, 2, 16}, {1, 6, 48}}} =
        xdb_schema_type:cast(datetime, {{2012, 2, 16}, {1, 6, 48}}),
    {ok, {{2012, 2, 16}, {1, 6, 48}}} =
        xdb_schema_type:cast(datetime, <<"2012-02-16T01:06:48Z">>),
    {ok, {{2012, 2, 16}, {1, 6, 48}}} =
        xdb_schema_type:cast(datetime, "2012-02-16T01:06:48Z"),
