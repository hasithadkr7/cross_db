...
-type w_respose() :: {ok, xdb_schema:t()} | {error, xdb_changeset:t()} | no_return().
%% Execute the actiopn or raise an error
-type exec_or_raise(R) :: R | no_return().

-export_type([t/0, w_respose/0, exec_or_raise/1]).
...
-callback init(Config) -> Res
    when Config :: xdb_lib:keyword(),
         Res :: {ok, xdb_lib:keyword()} | ignore.
-callback all(Queryable, Opts) -> Res
    when Queryable :: xdb_query:t() | xdb_query:queryable(),
         Opts :: xdb_lib:keyword(),
         Res :: [xdb_schema:t()] | no_return().
-callback get(Queryable, Id, Opts) -> Res
    when Queryable :: xdb_query:queryable(),
         Id :: any(),
         Opts :: xdb_lib:keyword(),
         Res :: xdb_schema:t() | undefined | no_return().
-callback get_or_raise(Queryable, Id, Opts) -> Res
    when Queryable :: xdb_query:queryable(),
         Id :: any(),
         Opts :: xdb_lib:keyword(),
         Res :: xdb_schema:t() | no_return().
-callback get_by(Queryable, Clauses, Opts) -> Res
    when Queryable :: xdb_query:queryable(),
         Clauses :: xdb_lib:keyword(),
         Opts :: xdb_lib:keyword(),
         Res :: xdb_schema:t() | undefined | no_return().
-callback get_by_or_raise(Queryable, Clauses, Opts) -> Res
    when Queryable :: xdb_query:queryable(),
         Clauses :: xdb_lib:keyword(),
         Opts :: xdb_lib:keyword(),
         Res :: xdb_schema:t() | no_return().
-callback insert(Schema, Opts) -> Res
    when Schema :: xdb_schema:t(),
         Opts :: xdb_lib:keyword(),
         Res :: w_respose().
-callback insert_or_raise(Schema, Opts) -> Res
    when Schema :: xdb_schema:t(),
         Opts :: xdb_lib:keyword(),
         Res :: exec_or_raise(xdb_schema:t()).
-callback insert_all(SchemaMod, Entries, Opts) -> Res
    when SchemaMod :: module(),
         Entries :: [xdb_schema:fields()],
         Opts :: xdb_lib:keyword(),
         Count :: integer(),
         Returning :: [xdb_schema:fields()] | undefined,
         Res :: {Count, Returning} | no_return().
-callback delete(Data, Opts) -> Res
    when Data :: xdb_schema:t() | xdb_changeset:t(),
         Opts :: xdb_lib:keyword(),
         Res :: w_respose().
-callback delete_or_raise(Data, Opts) -> Res
    when Data :: xdb_schema:t() | xdb_changeset:t(),
         Opts :: xdb_lib:keyword(),
         Res :: exec_or_raise(xdb_schema:t()).
-callback delete_all(Queryable, Opts) -> Res
    when Queryable :: xdb_query:t() | xdb_query:queryable(),
         Opts :: xdb_lib:keyword(),
         Res :: {integer(), [any()] | undefined} | no_return().
-callback update(Changeset, Opts) -> Res
    when Changeset :: xdb_changeset:t(),
         Opts :: xdb_lib:keyword(),
         Res :: w_respose().
-callback update_or_raise(Changeset, Opts) -> Res
    when Changeset :: xdb_changeset:t(),
         Opts :: xdb_lib:keyword(),
         Res :: exec_or_raise(xdb_schema:t()).
-callback update_all(Queryable, Updates, Opts) -> Res
    when Queryable :: xdb_query:t() | xdb_query:queryable(),
...
-callback transaction(Fun, Opts) -> Res
    when Fun :: fun(() -> any()),
         Opts :: xdb_lib:keyword(),
