...
%% API
-export([all/3, all/4, all_by/4, get/4, get/5, get_or_raise/4, get_or_raise/5, get_by/4,
         get_by/5, get_by_or_raise/4, get_by_or_raise/5, delete_all/3, delete_all/4, update_all/4,
         update_all/5, transaction/3, transaction/4]).
...
-spec all(Repo, Adapter, Queryable, Opts) -> Res
...
-spec get(Repo, Adapter, Queryable, Id, Opts) -> Res
    when Repo :: xdb_repo:t(),
         Adapter :: xdb_adapter:t(),
...
-spec get_or_raise(Repo, Adapter, Queryable, Id, Opts) -> Res
    when Repo :: xdb_repo:t(),
         Adapter :: xdb_adapter:t(),
         Queryable :: xdb_query:queryable(),
         Id :: any(),
...
-spec get_by(Repo, Adapter, Queryable, Clauses, Opts) -> Res
    when Repo :: xdb_repo:t(),
         Adapter :: xdb_adapter:t(),
         Queryable :: xdb_query:queryable(),
...
-spec get_by_or_raise(Repo, Adapter, Queryable, Clauses, Opts) -> Res
    when Repo :: xdb_repo:t(),
         Adapter :: xdb_adapter:t(),
         Queryable :: xdb_query:queryable(),
         Clauses :: xdb_lib:keyword(),
...
-spec delete_all(Repo, Adapter, Queryable, Opts) -> Res
    when Repo :: xdb_repo:t(),
         Adapter :: xdb_adapter:t(),
         Queryable :: xdb_query:t() | xdb_query:queryable(),
         Opts :: xdb_lib:keyword(),
...
-spec update_all(Repo, Adapter, Queryable, Updates, Opts) -> Res
    when Repo :: xdb_repo:t(),
         Adapter :: xdb_adapter:t(),
         Queryable :: xdb_query:t() | xdb_query:queryable(),
...
-spec transaction(Repo, Adapter, Fun, Opts) -> Res
    when Repo :: xdb_repo:t(),
         Adapter :: xdb_adapter:t(),
         Fun :: fun(() -> any()),
         Opts :: xdb_lib:keyword(),
...
one(Repo, Adapter, Queryable, Clauses, Opts) ->
    ...
    case all(Repo, Adapter, Query, Opts) of
        ...
        [] ->
            undefined;
        Other ->
            xdb_exception:multiple_results_error(Query, length(Other))
    end.
