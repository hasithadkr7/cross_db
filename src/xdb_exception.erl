...
-export([invalid_changeset_error/1, no_primary_key_field_error/1,
         no_primary_key_value_error/2, multiple_results_error/2, no_results_error/1,
         stale_entry_error/2, no_transaction_is_active/0, invalid_query_error/2]).
