...
%% API
-export([from/1, from/2, operators/0, validate_operator/1, pk_filter/2]).
...
-export_type([queryable/0, conditions/0, sort/0, t/0]).
...
-spec pk_filter(PKs, Conditions) -> Res
    when PKs :: [atom()],
